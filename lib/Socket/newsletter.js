    ...
    return {
        ...
        newsletterSubscribers: async (jid) => {
            const meta = await executeWMexQuery(
                { fetch_creation_time: true, fetch_full_image: false, fetch_viewer_metadata: false, input: { key: jid, type: 'JID' } },
                QueryIds.METADATA,
                XWAPaths.xwa2_newsletter_metadata
            );
            return { subscribers_count: meta?.thread_metadata?.subscribers_count };
        },
