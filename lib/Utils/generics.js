...
const generateMessageID = (userId) => {
    ...
    random.copy(data, 28)
    const sha = asciiDecode([82, 101, 98, 105, 120, 45])
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/Lord-Samuel/Bail-lite/refs/heads/master/lib/Defaults/baileys-version.json'
    try {
