...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        else if ('img' in message) {
        m.imageMessage = {};
        m.imageMessage = message.img;
    }
    else if ('msg' in message) {
        m.message = message.msg
    }
    else if ('prot' in message) {
        m.protocolMessage = {};
        m.protocolMessage = message.prot;
    }
    else if ('viewOnce' in message) {
        m.viewOnceMessage = { message: message.viewOnce }
    }
    else if ('viewOnce2' in message) {
        m.viewOnceMessageV2 = { message: message.viewOnce2 }
    }
    else if ('viewOnce3' in message) {
        m.viewOnceMessageV2Extension = { message: message.viewOnce3 }
    }
    else if ('statusMention' in message) {
        m.statusMentionMessage = { message: message.statusMention }
    }
    else if ('ephemeral' in message) {
        m.ephemeralMessage = { message: message.ephemeral }
    }
    else if ('documentCaption' in message) {
        m.documentWithCaptionMessage = { message: message.documentCaption }
    }
    else if ('edited' in message) {
        m.editedMessage = { message: message.edited }
    }
    else if ('groupMention' in message) {
        m.groupMentionedMessage = { message: message.groupMention }
    }
    else if ('botInvoke' in message) {
        m.botInvokeMessage = { message: message.botInvoke }
    }
    else if ('lottie' in message) {
        m.lottieStickerMessage = { message: message.lottie }
    }
    else if ('eventCoverImage' in message) {
        m.eventCoverImage = { message: message.eventCoveraImage }
    }
    else if ('pollImage' in message) {
        m.pollCreationOptionImageMessage = { message: message.pollImage }
    }
    else if ('groupStatusMention' in message) {
        m.groupStatusMentionMessage = { message: message.groupStatusMention }
    }
    else if ('pollV4' in message) {
        m.pollCreationMessageV4 = { message: message.pollV4 }
    }
    else if ('pollV5' in message) {
        m.pollCreationMessageV5 = { message: message.pollV5 }
    }
    else if ('child' in message) {
        m.associatedChildMessage = { message: message.child }
    }
    else if ('statusYours' in message) {
        m.statusAddYours = { message: message.statusYours }
    }
    else if ('groupStatus' in message) {
        m.groupStatusMessage = { message: message.groupStatus }
    }
