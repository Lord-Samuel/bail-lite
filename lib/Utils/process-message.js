...
const processMessage = async (message, { shouldProcessHistoryMsg, placeholderResendCache, ev, creds, keyStore, logger, options, getMessage }) => {
    ...
    if (protocolMsg) {
        ...
        if (pollMsg) {
            const actualPollMsg = pollMsg.viewOnceMessage?.message || pollMsg.botInvokeMessage?.message || pollMsg;
            const meIdNormalised = (0, WABinary_1.jidNormalizedUser)(meId);
            const pollCreatorJid = (0, generics_1.getKeyAuthor)(creationMsgKey, meIdNormalised);
            const voterJid = (0, generics_1.getKeyAuthor)(message.key, meIdNormalised);
            const pollEncKey = (_r = actualPollMsg.messageContextInfo) === null || _r === void 0 ? void 0 : _r.messageSecret;
            try {
